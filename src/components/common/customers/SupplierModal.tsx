                    ...
                    {mode === "delete" ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-slate-300 mb-6">
                                لا يمكن التراجع عن هذا الإجراء. سيتم حذف جميع البيانات المرتبطة بهذا المورد.
                            </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <input type="hidden" name="customerType" value={CustomerTypeEnum.SUPPLIER} />
                            ...
                            {success && (
                                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
                                    <p className="text-green-400 text-sm">
                                        {mode === "create" ? "تم إضافة المورد بنجاح!" : "تم تحديث بيانات المورد بنجاح!"}
                                    </p>
                                </div>
                            )}
